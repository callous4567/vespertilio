...
const bool SRAM_SPI = 1; // true false 1 0 
...
// set sram to start an 8-bit sequential read at address. note that you must deselect once complete. Handles initial selection.
void SRAM_start_sequential_read(sram_t *SRAM, int address); 

// set sram to start a 16-bit sequential read at address. must call SRAM_SPI8() and SRAM_DESELECT() at end. Handles initial selection. 
void SRAM_start_sequential_read16(sram_t *SRAM, int address); 

// set sram to start an 8-bit sequential write at address. note that you must deselect once complete. Handles initial selection.
void SRAM_start_sequential_write(sram_t *SRAM, int address); 

// set sram to start a 16-bit sequential write at address. must call SRAM_SPI8() and SRAM_DESELECT() at end. Handles initial selection. 
